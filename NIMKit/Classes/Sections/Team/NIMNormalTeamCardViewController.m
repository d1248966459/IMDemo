...
- (NSArray*)buildBodyData{
    ...
    if ([self.team.clientCustomInfo isEqualToString:@"讨论组"]) {
...
- (void)quitTeam{
    ...
    _quitTeamAlertView = [[UIAlertView alloc] initWithTitle:@"" message:quitItem delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确认", nil];
...
- (void)dismissTeam{
    ...
    _dismissTeamAlertView = [[UIAlertView alloc] initWithTitle:@"" message:quitItem delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确认", nil];
