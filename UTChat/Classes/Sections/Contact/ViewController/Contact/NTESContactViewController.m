...
//原始数据
    ...
    NSMutableArray *utils =
            [@[
              ...
              @{
                  contactCellUtilIcon:@"youke_group_normal",
                  contactCellUtilTitle:@"悠客群",//高级群
                  contactCellUtilVC:@"NTESAdvancedTeamListViewController"
               },
              @{
                  contactCellUtilIcon:@"discuss_normal",
                  contactCellUtilTitle:@"讨论组",
                  contactCellUtilVC:@"NTESNormalTeamListViewController"
                },
              @{
                  contactCellUtilIcon:@"normal_group",
                  contactCellUtilTitle:@"系统群",
                  contactCellUtilVC:@"NTESHighTeamListViewController"
                },
              @{
                  contactCellUtilIcon:@"black_list_normal",
...
- (void)onOpera:(id)sender{
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:nil delegate:nil cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"添加悠客",@"创建悠客群",@"创建讨论组",@"搜索悠客群", nil];
...
//                    option.type       = NIMTeamTypeTaoLunZu;
